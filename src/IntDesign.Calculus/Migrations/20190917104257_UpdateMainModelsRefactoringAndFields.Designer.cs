...
namespace Calculus.Migrations
{
    ...
    [Migration("20190917104257_UpdateMainModelsRefactoringAndFields")]
    partial class UpdateMainModelsRefactoringAndFields
    {
            ...
            modelBuilder.Entity("Calculus.Core.Models.MainModels.RoomJob", b =>
                {
                    b.HasOne("Calculus.Core.Models.MainModels.Room", "Room")
                        .WithOne("RoomJob")
                        .HasForeignKey("Calculus.Core.Models.MainModels.RoomJob", "RoomId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
